 ...
 */
export default class BigHeadTune {
    /**
    ...
    constructor({ api, data, config, block }) {
        ...
        this.settings = Object.assign({}, config, {
            icon: IconStretched,
            title: this.api.i18n.t('Великий заголовок'),
        })
    ...
    tuneClicked(event) {
        ...
        this.wrapper.classList.toggle(BigHeadTune.CSS.applied, this.data);
    }
     ...
     */
    wrap(blockContent) {
        this.wrapper = make('div', BigHeadTune.CSS.wrapper);
